// src/pages/PreMonthlyCalculator.jsx
    ...
    <Container maxWidth="sm" sx={{ mt: 5, mb: 5 }}>
      ...
      {result && (
        <Paper sx={{ p: 3, bgcolor: '#d0f0c0', mb: 2 }}>
          <Typography variant="h5" align="center" sx={{ fontWeight: 'bold' }}>
            Your Calculated Pre-Monthly Bonus is ${result}
          </Typography>
        </Paper>
      )}
      ...
      <Paper sx={{ p: 4, mb: 2 }}>
        <Typography variant="h4" gutterBottom>
          How to Calculate Stake.com’s Pre-Monthly Bonus
        </Typography>
        <Typography variant="body1" paragraph>
          The pre‑monthly bonus applies to wagers placed before the monthly cutoff. Although the exact calculation is confidential, it depends on key factors such as your VIP rank, total wager for the last 30 days, and your net profit or loss.
        </Typography>
        <List>
          <ListItem>
            <ListItemText primary="VIP Rank" secondary="Your VIP status determines your bonus multiplier." />
          </ListItem>
          <ListItem>
            <ListItemText primary="Wagered Amount (Last 30 Days)" secondary="Your total wagered amount is a major factor." />
          </ListItem>
          <ListItem>
            <ListItemText primary="Profit or Loss" secondary="Your net performance during the period plays an essential role." />
          </ListItem>
          <ListItem>
            <ListItemText primary="House Edge" secondary="The advantage of the games you play may also influence the bonus." />
          </ListItem>
        </List>
        <Divider sx={{ my: 3 }} />
        <Typography variant="h5" gutterBottom>
          How the Pre-Monthly Bonus Calculator Works
        </Typography>
        <Typography variant="body1" paragraph>
          Exclusively available to Stake VIP members, our calculator uses your wagering data and VIP level to generate an estimated bonus value.
        </Typography>
        <Typography variant="h5" gutterBottom>
...
export default PreMonthlyCalculator;