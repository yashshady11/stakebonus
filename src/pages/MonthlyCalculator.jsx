// src/pages/MonthlyCalculator.jsx
...
function MonthlyCalculator() {
  ...
  const [profitOrLoss, setProfitOrLoss] = useState(''); // (not used in formula below, but could be used if you extend the logic)
    ...
    <Container maxWidth="sm" sx={{ mt: 5, mb: 5 }}>
      ...
      {result && (
        <Paper sx={{ p: 3, bgcolor: '#d0f0c0', mb: 2 }}>
          <Typography variant="h5" align="center" sx={{ fontWeight: 'bold' }}>
            Your Calculated Monthly Bonus is ${result}
          </Typography>
        </Paper>
      )}
      ...
      <Paper sx={{ p: 4, mb: 2 }}>
        <Typography variant="h4" gutterBottom>
          How to Calculate Stake.com’s Monthly Bonus
        </Typography>
        <Typography variant="body1" paragraph>
          Although the exact formula for Stake’s monthly bonus is confidential, it is based on several key factors including your VIP rank, the total wagered amount over the last 30 days, and your net profit or loss. Our calculator uses these elements to provide an approximate bonus value.
        </Typography>
        <List>
          <ListItem>
            <ListItemText primary="VIP Rank" secondary="Your current VIP status directly influences your bonus multiplier." />
          </ListItem>
          <ListItem>
            <ListItemText primary="Wagered Amount (Last 30 Days)" secondary="The total wagered amount in the last 30 days is critical." />
          </ListItem>
          <ListItem>
            <ListItemText primary="Profit or Loss" secondary="Your net performance during the month significantly affects your bonus." />
          </ListItem>
          <ListItem>
            <ListItemText primary="House Edge" secondary="The inherent advantage of the games you play may also be considered." />
          </ListItem>
        </List>
        <Divider sx={{ my: 3 }} />
        <Typography variant="h5" gutterBottom>
          How the Monthly Bonus Calculator Works
        </Typography>
        <Typography variant="body1" paragraph>
          Exclusively available to Stake VIP members, our calculator combines your wagering data and VIP status to generate an estimated bonus value.
        </Typography>
        <Typography variant="h5" gutterBottom>
          Step-by-Step Guide
        </Typography>
        <Typography variant="body1" paragraph>
          1. Enter the total wagered amount for the last 30 days.
          <br />
